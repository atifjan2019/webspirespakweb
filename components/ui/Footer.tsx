      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16">
        ...
        <div className="mt-16 pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            <a href="https://www.linkedin.com/company/webspires" target="_blank" rel="noopener noreferrer" className="text-brand-gray hover:text-white transition-colors duration-200">
            ...
            <a href="https://www.facebook.com/webspires" target="_blank" rel="noopener noreferrer" className="text-brand-gray hover:text-white transition-colors duration-200">
